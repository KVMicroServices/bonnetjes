...
- [x] 1. Add EmailTemplateOverride Prisma model and migration
...
- [x] 2. Create email-template-override-service
...
- [x] 3. Create API routes (CRUD, translate, preview)
...
- [x] 4. Integrate overrides into email translation loader
...
- [x] 5. Admin settings UI — email template editor section
